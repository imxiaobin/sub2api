export default {
    accounts: {
      ...
      duplicate: 'Copy',
      duplicating: 'Copying...',
      duplicateSuccess: 'Account duplicated as "{name}".',
      duplicateSharedCredentialSuccess: 'Account duplicated as "{name}". The copy shares one OAuth credential with its source: if the provider rotates the refresh token on either account, the other stops working and needs re-authorization.',
