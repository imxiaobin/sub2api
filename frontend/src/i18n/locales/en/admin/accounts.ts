export default {
    accounts: {
      ...
      duplicateSharedCredentialSuccess: 'Account duplicated as "{name}" and paused. The copy shares one OAuth credential with its source: if the provider rotates the refresh token on either account, the other stops working and needs re-authorization.',
